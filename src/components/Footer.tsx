...
import {
  ...
  ArrowUpRight, Facebook, Instagram,
  Sun
} from 'lucide-react';
...
const Footer = () => {
  ...
  const socials = [
    { Icon: Facebook, href: 'https://www.facebook.com/SulaxIndustries/', label: 'Facebook' },
    { Icon: Instagram, href: 'https://www.instagram.com/sulaxsolar/', label: 'Instagram' },
  ];
